# Generated by Django 3.2 on 2023-07-11 19:21
...
def forwards_func(apps, schema_editor):
    ...
    использованием этого приложения. Мы хотим, чтобы они могли видеть     всё, что происходит на сайте, просматривать отчёты, которые им предоставляются. После того как сотрудники подключили ZOOM, нам \ важно, чтобы каждый секретарь, менеджер и прочие были \ подключены ко всем 5 компьютерам.",
    )
    News.objects.create(
